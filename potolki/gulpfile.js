...
gulp.task('scripts', function() {
    return gulp.src([ // Берем все необходимые библиотеки
        ...
        'app/assets/libs/cascade-slider/cascade-slider.js',// Glider Carousel
        'app/assets/libs/jquery.maskedinput/dist/jquery.maskedinput.min.js', // Phone Mask
        'app/assets/libs/jquery-ui-1.12.1/jquery-ui.min.js', // jQuery UI
        'app/assets/libs/jquery-ui-1.12.1/jquery.ui.touch-punch.min.js' // jQuery UI Tuch
    ])
